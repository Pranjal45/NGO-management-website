    ...
    <div class="container fluid">
      ...
      <form id="redirectForm" method="post" action="request.php">
        <div class="form-group">
          ...
          <input class="form-control" name="appId" value="TEST39343264dfae472d4efc91dd7e234393"/>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input class="form-control" name="returnUrl" value="http://localhost/cashfree_integration_php/checkout/response.php"/>
        </div>        
        <div class="form-group">
